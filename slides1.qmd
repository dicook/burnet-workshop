...
- variables: budget possibility, allocation

we can do more with more funds?

## errors

- stacking impedes comparing categories, especially betweeen different budget amounts
- too many colours. there appears to be some hierarchy or larger categories?

## correct

- budget mapped to common axis. however, the total amount is not the main message.
...
- stacking makes it difficult to read change in proportion of "susceptible" and "uncategorisable" and "HBV infection"
- table not aligned with bars
- missing overall numbers over years


## correct

- % mapped to position along a line
...
- marking event
- alignment of n to position along a line
- time on x axis
...
? presence or proportion (BULK/AIM) for top combinations
...
- Axis is marking min and max, unorthodox, and too far under plot to connect immediately
...
- Focus on proportions in each category

## 2

- Mosaic plot to show proportions and counts

## 3

- Separate or align table, add proportions/percentages to table
